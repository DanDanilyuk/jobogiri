class ScrapeIndeedJob < ApplicationJob
  ...
  def perform
    duplicates = 0
    start = Time.now
    url = 'https://www.indeed.com/jobs?as_and=&as_phr=%22developer%22&as_any=Ruby+Rails+Ruby-On-Rails+ROR+Angular+Lambda+Javascript+React+Front-End+Back-End+AWS+Sinatra+RSPEC+HTML+CSS&as_not=senior+sr+salesforce+ios+android&as_ttl=&as_cmp=&jt=all&st=&salary=&radius=25&fromage=1&limit=50&sort=date&psf=advsrch'
